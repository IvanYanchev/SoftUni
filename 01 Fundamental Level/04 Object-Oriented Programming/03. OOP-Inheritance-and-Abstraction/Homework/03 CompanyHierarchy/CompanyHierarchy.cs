...
namespace CompanyHierarchy
{
    class CompanyHierarchy
    {
        static void Main()
        {
            Project project1 = new Project("Zaludo raboti", new DateTime(2014, 02, 12), "zaludo bez rabota ne stoj!");
            Project project2 = new Project("Prituri se planinata", new DateTime(2015, 01, 01), "...");
            Project project3 = new Project("Probiwame dupki wsqkakwi", new DateTime(2014, 11, 20), "...");
            Project project4 = new Project("Svobodata, Sancho!", new DateTime(2013, 05, 05), "Dulcinea");
            Project project5 = new Project("S curvuli po divia zapad", new DateTime(2015, 02, 19), "...");
            ...
            Developer dev1 = new Developer(2358328582, "Georgi", "Georgiev", 1500, Department.Production);
            ...
            SalesEmployee salempl1 = new SalesEmployee(8729822223, "Krasimir", "Yordanov", 1900, Department.Sales, sale1, sale2, sale3);
            ...
            Manager boss2 = new Manager(3742376423, "Oleg", "Zapryanov", 3500, Department.Sales, salempl1, salempl2, salempl3);
            ...
            cust1.AddPurchaseAmount(23.40);
            cust2.AddPurchaseAmount(485.0);
            cust3.AddPurchaseAmount(1089.90);

            List<Person> persons = new List<Person>() { cust1, cust2, cust3, dev1, dev2, dev3, salempl1, salempl2, salempl3, boss1, boss2, boss3 };
